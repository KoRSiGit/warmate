...
(function( window, document, undefined ) {
	...
	// https://jsperf.com/whitespace-character/5
	function isSpace(c) {
		return (c === "\u0020" || // space
		        c === "\u0009" || // horizontal tab
		        c === "\u000A" || // new line
	...
	// test svg support
	types[ "image/svg+xml" ] = document.implementation.hasFeature( "https://wwwindow.w3.org/TR/SVG11/feature#Image", "1.1" );
	...
	function parseSizes(strValue) {
		...
		// https://dev.w3.org/csswg/css-values/#numbers
		...
		//  Quick tests: https://jsfiddle.net/gtntL4gr/3/
		...
		function isValidNonNegativeSourceSizeValue(s) {
			...
			// ( https://www.w3.org/TR/CSS2/syndata.html#numbers says:
		...
		// https://dev.w3.org/csswg/css-syntax/#parse-comma-separated-list-of-component-values
		...
		for (i = 0; i < unparsedSizesListLength; i++) {
			...
			// of this algorithm.
			// https://dev.w3.org/csswg/css-syntax/#parse-component-value
	 ...
	 * https://dev.w3.org/csswg/css-values-3/#length-value
	 ...
	 * where resolution is https://dev.w3.org/csswg/css-values-3/#resolution-value
	...
	if ( pf.supPicture ) {
		...
		(function() {
			...
			// https://modernjavascript.blogspot.com/2013/08/building-better-debounce.html
