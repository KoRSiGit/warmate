...
!*/
I.addTest("svg",!!d.createElementNS&&!!d.createElementNS("https://www.w3.org/2000/svg","svg").createSVGRect);
/*!
{
...
!*/
I.addTest("inlinesvg",function(){var i=G("div");i.innerHTML="<svg/>";return(typeof SVGRect!="undefined"&&i.firstChild&&i.firstChild.namespaceURI)=="https://www.w3.org/2000/svg"});
/*!
{
...
!*/
I.addTest("svgclippaths",function(){return !!d.createElementNS&&/SVGClipPath/.test(x.call(d.createElementNS("https://www.w3.org/2000/svg","clipPath")))});
/*!
{
